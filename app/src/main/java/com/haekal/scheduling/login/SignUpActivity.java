...
import com.haekal.scheduling.model.Request;

public class SignUpActivity extends AppCompatActivity {

    private EditText mEmail, mPassword,mNim,mKelas,mNama;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNim = (EditText) findViewById(R.id.signup_nim);
        ...
        mRegistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String Snim = mNim.getText().toString();
                ...
                if (Snama.equals("")){
                    ...
                    mNim.setError("Masukkan email terlebih dahulu!");
                    mNim.requestFocus();
                }
